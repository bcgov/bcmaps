...
- `is_dir`, is it a directory? If you have cached tiles from the
  [`cded()`](http://bcgov.github.io/bcmaps/reference/cded.md) functions,
  there will be a row in the data frame showing the total size of the
  cded tiles cache directory.
