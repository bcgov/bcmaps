...
mapsheets_250K_data <- canada_250[canada_250$MAP_TILE_DISPLAY_NAME %in% bc_mapsheet_250K_names(), ]
...
mapsheets_50K_data <- canada_50[canada_50$grid_250K %in% bc_mapsheet_250K_names(), ]
