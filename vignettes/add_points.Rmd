...
output:
  rmarkdown::html_vignette:
    ...
    fig_height: 5
vignette: >
  %\VignetteIndexEntry{Working with bcmaps layers with point location data}
...
<img src="vignette-fig-convert-1.png" title="plot of chunk convert" alt="plot of chunk convert" width="100%" />
...
<img src="vignette-fig-overlay-1.png" title="plot of chunk overlay" alt="plot of chunk overlay" width="100%" />
...
```r
ecoreg <- ecoregions()
#> bcmaps would like to store this layer in the directory:
#> /Users/ateucher/Library/Caches/org.R-project.R/R/bcmaps
#> Is that okay?
#> 1: Yes
#> 2: No
#> 
