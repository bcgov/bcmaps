...
Further development of the `bcmaps` package is on hold until the enhancements outlined in
[Issue #2](https://github.com/bcgov/bcmaps/issues/2) and [#21](https://github.com/bcgov/bcmaps/issues/21) are implemented. We are hoping to tackle these in 2018.
