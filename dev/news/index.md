...
- [`utm_convert()`](http://bcgov.github.io/bcmaps/dev/reference/utm_convert.md)
...
- Added function
  [`cded_terra()`](http://bcgov.github.io/bcmaps/dev/reference/cded_terra.md)
- Deprecated function
  [`cded_raster()`](http://bcgov.github.io/bcmaps/dev/reference/cded_raster.md) -
...
- Removed the `class` argument in all of the data download functions:
  [`get_layer()`](http://bcgov.github.io/bcmaps/dev/reference/get_layer.md)
...
- The `Spatial` method of
  ...
  is removed.
- [`fix_geo_problems()`](http://bcgov.github.io/bcmaps/dev/reference/fix_geo_problems.md)
  is removed. For `sf` objects simply use
  [`sf::st_make_valid()`](https://r-spatial.github.io/sf/reference/valid.html)
- [`self_union()`](http://bcgov.github.io/bcmaps/dev/reference/self_union.md)
...
- [`get_poly_attribute()`](http://bcgov.github.io/bcmaps/dev/reference/get_poly_attribute.md)
  is removed.
- [`raster_by_poly()`](http://bcgov.github.io/bcmaps/dev/reference/raster_by_poly.md)
...
- New helper function
  [`show_cached_files()`](http://bcgov.github.io/bcmaps/dev/reference/delete_cache.md)
...
- When R version is \>= 4.0, bcmaps will use
  ...
  [`bcmaps::delete_cache()`](http://bcgov.github.io/bcmaps/dev/reference/delete_cache.md)
...
- Use of parallelism in functions that allow it
  ([`raster_by_poly()`](http://bcgov.github.io/bcmaps/dev/reference/raster_by_poly.md)
  &
  [`summarize_raster_list()`](http://bcgov.github.io/bcmaps/dev/reference/summarize_raster_list.md))
...
- Added
  [`bc_neighbours()`](http://bcgov.github.io/bcmaps/dev/reference/bc_neighbours.md)
...
- Added
  ...
  to get a bounding box for British Columbia
...
- `bec` (and other large downloadable layers) show up in the output of
  [`available_layers()`](http://bcgov.github.io/bcmaps/dev/reference/available_layers.md),
  [`bec()`](http://bcgov.github.io/bcmaps/dev/reference/bec.md) works,
  and `get_layer("bec")` works so that getting downloadable datasets is
...
- Added the ability to download Biogeoclimatic Zone map - as it was too
  ...
  [`bec()`](http://bcgov.github.io/bcmaps/dev/reference/bec.md), which
  uses the new function `get_big_data()`
  ([\#28](https://github.com/bcgov/bcmaps/issues/28)).
- Added function
  [`bec_colours()`](http://bcgov.github.io/bcmaps/dev/reference/bec_colours.md)
  (and alias
  [`bec_colors()`](http://bcgov.github.io/bcmaps/dev/reference/bec_colours.md))
