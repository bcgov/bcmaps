...
[`bec()`](http://bcgov.github.io/bcmaps/reference/bec.md) function, and
...
- [`transform_bc_albers()`](http://bcgov.github.io/bcmaps/reference/transform_bc_albers.md)
  ...
  projection
- [`bc_area()`](http://bcgov.github.io/bcmaps/reference/bc_area.md) to
  get the total area of British Columbia in various units
- [`bc_bbox()`](http://bcgov.github.io/bcmaps/reference/bc_bbox.md) to
  get an extend/bounding box for British Columbia
